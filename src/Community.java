...
public class Community implements Serializable{
    ...
    public final int RETURN_TAG_DUPULICATE = 1; //addTagメソッドで追加しようとしたタグが、既にタグリストに存在していたとき返り値
    public final int RETURN_TAG_FULL = 2; //addTagメソッドでタグを追加しようとしたものの、既にタグが5個設定されていて追加できなかったときの返り値
    public final int CALENDAR_YEARS = 10; //何年分のカレンダーを生成するか
